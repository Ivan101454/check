...
public class ConcreteCheckWithDiscount extends Check {
    ...
    public void createCheck() {
        ...
        DiscountCard discountCard = mapDiscount.get(Integer.parseInt(discount));
